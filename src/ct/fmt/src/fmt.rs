...
mod tests {
    ...
    mod ct_main_tests {
        ...
        #[test]
        fn test_fmt_main_with_file_crown_margin_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_crown_margin_short() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tagged_paragraph_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tagged_paragraph_short() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_preserve_headers_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_preserve_headers_short() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_split_only_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_split_only_short() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_uniform_spacing_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_uniform_spacing_short() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_long_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_prefix_short_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_prefix_short_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_prefix_long_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_long_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_long_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        // #[test]
        // fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_long_with_record_separator()
        // {
        //     let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
        //     let temp_dir_path = tmp_dir.path();
        //     let test_file_path = temp_dir_path.join("test_fmt_file");
        ...
        // }
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_long_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_long_exact_skip_prefix_short_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_long_exact_skip_prefix_short_with_record_separator()
        {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_group_separator()
        {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_skip_prefix_short_exact_skip_prefix_short_with_record_separator()
        {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_space() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_letter() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_digital() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_comma() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_semicolon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_colon() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_vertical() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_tab() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_group_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_unit_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_prefix_short_exact_skip_prefix_short_with_record_separator() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_long_none() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_long_0() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_long_1() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_long_10() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_long_100() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_long_1000() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_short_none() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_short_0() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_short_1() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_short_10() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_short_100() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_width_short_1000() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_goal_long_none() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_goal_long_10() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_goal_long_100() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_goal_long_1000() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_goal_short_none() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_goal_short_10() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_goal_short_100() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_goal_short_1000() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_quick_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_quick_short() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_long_none() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_long_0() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_long_1() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_long_10() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_long_100() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_long_1000() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_short_none() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_short_0() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_short_1() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_short_10() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_short_100() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_fmt_main_with_file_tab_width_short_1000() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
    ...
    mod ct_app_tests {
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_space() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", " ", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_letter() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "a", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_digital() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "5", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_comma() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", ",", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_semicolon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", ";", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_colon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", ":", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_vertical() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "|", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_tab() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\t", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_group_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\u{001d}", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_unit_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\u{001f}", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_long_with_record_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\u{001e}", "--exact-prefix"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_space() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", " ", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_letter() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "a", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_digital() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "5", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_comma() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", ",", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_semicolon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", ";", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_colon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", ":", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_vertical() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "|", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_tab() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\t", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_group_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\u{001d}", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_unit_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\u{001f}", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_prefix_short_with_record_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\u{001e}", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("prefix"),
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_space() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_letter() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_digital() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_comma() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--skip-prefix", ",", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_semicolon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--skip-prefix", ";", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_colon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--skip-prefix", ":", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_vertical() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--skip-prefix", "|", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_tab() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--skip-prefix", "\t", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_group_separator() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_unit_separator() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_prefix_short_with_record_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--skip-prefix", "\u{001e}", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("skip-prefix"),
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_space() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_letter() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_digital() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_comma() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--prefix", ",", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_semicolon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--prefix", ";", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_colon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--prefix", ":", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_vertical() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--prefix", "|", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_tab() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--prefix", "\t", "-x"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_group_separator() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_unit_separator() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_prefix_long_with_record_separator() {
            let command = ct_app();
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_skip_prefix_long_with_space() {
            let command = ct_app();
            let cmd_args = vec![
                ctcore::ct_util_name(),
                "--prefix",
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_skip_prefix_long_with_letter() {
            let command = ct_app();
            let cmd_args = vec![
                ctcore::ct_util_name(),
                "--prefix",
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_skip_prefix_long_with_digital() {
            let command = ct_app();
            let cmd_args = vec![
                ctcore::ct_util_name(),
                "--prefix",
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_skip_prefix_long_with_comma() {
            let command = ct_app();
            let cmd_args = vec![
                ctcore::ct_util_name(),
                "--prefix",
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_skip_prefix_long_with_semicolon() {
            let command = ct_app();
            let cmd_args = vec![
                ctcore::ct_util_name(),
                "--prefix",
        ...
        #[test]
        fn test_ct_app_prefix_long_exact_skip_prefix_long_with_colon() {
            let command = ct_app();
            let cmd_args = vec![
                ctcore::ct_util_name(),
                "--prefix",
        ...
        #[test]
        fn test_ct_app_skip_prefix_long_exact_skip_prefix_short_with_record_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--skip-prefix", "\u{001e}", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_space() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", " ", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_letter() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", "a", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_digital() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", "5", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_comma() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", ",", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_semicolon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", ";", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_colon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", ":", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_vertical() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", "|", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_tab() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", "\t", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_group_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", "\u{001d}", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_unit_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", "\u{001f}", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_skip_prefix_short_exact_skip_prefix_short_with_record_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-P", "\u{001e}", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_space() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", " ", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_letter() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "a", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_digital() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "5", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_comma() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", ",", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_semicolon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", ";", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_colon() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", ":", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_vertical() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "|", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_tab() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\t", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_group_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\u{001d}", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_unit_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\u{001f}", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_prefix_short_exact_skip_prefix_short_with_record_separator() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-p", "\u{001e}", "-X"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
        ...
        #[test]
        fn test_ct_app_width_long_none() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--width"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_err());
            assert_eq!(result.unwrap_err().kind(), ErrorKind::InvalidValue);
        }
        ...
        #[test]
        fn test_ct_app_width_long_0() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--width", "0"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("width"), Some(0).as_ref());
        }

        #[test]
        fn test_ct_app_width_long_1() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--width", "1"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("width"), Some(1).as_ref());
        }

        #[test]
        fn test_ct_app_width_long_10() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--width", "10"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("width"), Some(10).as_ref());
        }

        #[test]
        fn test_ct_app_width_long_100() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--width", "100"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<usize>("width"),
                Some(100).as_ref()
            );
        }

        #[test]
        fn test_ct_app_width_long_1000() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--width", "1000"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<usize>("width"),
        ...
        #[test]
        fn test_ct_app_width_short_none() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-w"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_err());
            assert_eq!(result.unwrap_err().kind(), ErrorKind::InvalidValue);
        }
        ...
        #[test]
        fn test_ct_app_width_short_0() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-w", "0"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("width"), Some(0).as_ref());
        }
        ...
        #[test]
        fn test_ct_app_width_short_1() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-w", "1"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("width"), Some(1).as_ref());
        }
        ...
        #[test]
        fn test_ct_app_width_short_10() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-w", "10"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("width"), Some(10).as_ref());
        }
        ...
        #[test]
        fn test_ct_app_width_short_100() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-w", "100"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<usize>("width"),
        ...
        #[test]
        fn test_ct_app_width_short_1000() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-w", "1000"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<usize>("width"),
        ...
        #[test]
        fn test_ct_app_goal_long_none() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--goal"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_err());
            assert_eq!(result.unwrap_err().kind(), ErrorKind::InvalidValue);
        }
        ...
        #[test]
        fn test_ct_app_goal_long_0() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--goal", "0"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("goal"), Some(0).as_ref());
        }

        #[test]
        fn test_ct_app_goal_long_1() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--goal", "1"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("goal"), Some(1).as_ref());
        }

        #[test]
        fn test_ct_app_goal_long_10() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--goal", "10"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("goal"), Some(10).as_ref());
        }

        #[test]
        fn test_ct_app_goal_long_100() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--goal", "100"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("goal"), Some(100).as_ref());
        }

        #[test]
        fn test_ct_app_goal_long_1000() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--goal", "1000"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<usize>("goal"),
                Some(1000).as_ref()
            );
        }

        #[test]
        fn test_ct_app_goal_short_none() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-g"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_err());
            assert_eq!(result.unwrap_err().kind(), ErrorKind::InvalidValue);
        }
        ...
        #[test]
        fn test_ct_app_goal_short_0() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-g", "0"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("goal"), Some(0).as_ref());
        }
        ...
        #[test]
        fn test_ct_app_goal_short_1() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-g", "1"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("goal"), Some(1).as_ref());
        }
        ...
        #[test]
        fn test_ct_app_goal_short_10() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-g", "10"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("goal"), Some(10).as_ref());
        }
        ...
        #[test]
        fn test_ct_app_goal_short_100() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-g", "100"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(result.unwrap().get_one::<usize>("goal"), Some(100).as_ref());
        }
        ...
        #[test]
        fn test_ct_app_goal_short_1000() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-g", "1000"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<usize>("goal"),
        ...
        #[test]
        fn test_ct_app_tab_width_long_none() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--tab-width"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_err());
            assert_eq!(result.unwrap_err().kind(), ErrorKind::InvalidValue);
        }
        ...
        #[test]
        fn test_ct_app_tab_width_long_0() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--tab-width", "0"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("tab-width"),
                Some(&"0".to_string())
            );
        }

        #[test]
        fn test_ct_app_tab_width_long_1() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--tab-width", "1"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("tab-width"),
        ...
        #[test]
        fn test_ct_app_tab_width_long_10() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--tab-width", "10"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("tab-width"),
        ...
        #[test]
        fn test_ct_app_tab_width_long_100() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--tab-width", "100"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("tab-width"),
        ...
        #[test]
        fn test_ct_app_tab_width_long_1000() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--tab-width", "1000"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("tab-width"),
        ...
        #[test]
        fn test_ct_app_tab_width_short_none() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "--tab-width"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_err());
        ...
        #[test]
        fn test_ct_app_tab_width_short_0() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-T", "0"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("tab-width"),
        ...
        #[test]
        fn test_ct_app_tab_width_short_1() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-T", "1"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("tab-width"),
        ...
        #[test]
        fn test_ct_app_tab_width_short_10() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-T", "10"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("tab-width"),
        ...
        #[test]
        fn test_ct_app_tab_width_short_100() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-T", "100"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("tab-width"),
        ...
        #[test]
        fn test_ct_app_tab_width_short_1000() {
            let command = ct_app();
            let cmd_args = vec![ctcore::ct_util_name(), "-T", "1000"];
            let result = command.try_get_matches_from(cmd_args);
            assert!(result.is_ok());
            assert_eq!(
                result.unwrap().get_one::<String>("tab-width"),
        ...
        #[test]
        fn test_ct_app_with_file_crown_margin_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_ct_app_with_file_crown_margin_short() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_ct_app_with_file_tagged_paragraph_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_ct_app_with_file_tagged_paragraph_short() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_ct_app_with_file_preserve_headers_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_ct_app_with_file_preserve_headers_short() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_ct_app_with_file_split_only_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_ct_app_with_file_split_only_short() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
        ...
        #[test]
        fn test_ct_app_with_file_uniform_spacing_long() {
            let tmp_dir = TempDir::with_prefix("test_fmt_").unwrap();
            let temp_dir_path = tmp_dir.path();
            let test_file_path = temp_dir_path.join("test_fmt_file");
            File::create(&test_file_path).unwrap();
