...
mod tests {
    ...
    mod tokenize_tests {
        ...
        #[test]
        fn test_tokenize_without_separator() {
            let line = "NoSeparator";
            let separator = None;
            let mut token_buffer = Vec::new();

            tokenize(line, separator, &mut token_buffer);
            let expected = vec![Field::from(0..11)];

            assert_eq!(token_buffer, expected);
        }

        #[test]
        fn test_tokenize_with_tab_separator() {
            let line = "Tab\tseparated\tfields";
            let separator = Some('\t');
            let mut token_buffer = Vec::new();
            tokenize(line, separator, &mut token_buffer);
            ...
            let expected = vec![
                Field::from(0..3),   // "Tab"
                Field::from(4..13),  // "separated"
                Field::from(14..20), // "fields"
            ];
            assert_eq!(token_buffer, expected);
        }

        #[test]
        fn test_tokenize_with_space_separator() {
            let line = "Space separated fields";
            let separator = Some(' ');
            let mut token_buffer = Vec::new();
            tokenize(line, separator, &mut token_buffer);

            let expected = vec![
                Field::from(0..5),   // "Space"
                Field::from(6..15),  // "separated"
                Field::from(16..22), // "fields"
            ];
            assert_eq!(token_buffer, expected);
        }
        ...
        #[test]
        fn test_tokenize_consecutive_separators() {
            let line = "hello,,world";
            let separator = Some(',');
            let mut token_buffer = Vec::new();
            tokenize(line, separator, &mut token_buffer);
    ...
    mod ct_main_tests {
        ...
        #[test]
        fn test_ct_main_default_exist_file() {
        ...
        #[test]
        fn test_ct_main_exist_file_ignore_leading_blanks_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_ignore_leading_blanks_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_dictionary_order_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_dictionary_order_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_ignore_case_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_general_numeric_sort_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_general_numeric_sort_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_ignore_nonprinting_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_ignore_nonprinting_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_month_sort_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_month_sort_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_human_numeric_sort_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_human_numeric_sort_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_numeric_sort_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_numeric_sort_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_random_sort_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_random_sort_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_reverse_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_reverse_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_random_sort_long_random_source() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_random_sort_short_random_source() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_sort_long_general_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_sort_long_human_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_sort_long_month() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_sort_long_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_sort_long_random() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_sort_long_version() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_reverse_short_sort_long_general_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_reverse_short_sort_long_human_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_reverse_short_sort_long_month() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_reverse_short_sort_long_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_reverse_short_sort_long_random() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_reverse_short_sort_long_version() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_unique_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_check_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_check_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_check_uppercase_c_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_check_long_diagnose_first() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_check_long_silent() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_check_long_quiet() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_check_short_silent() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_check_short_quiet() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_check_short_diagnose_first() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_key_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_two_key_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_key_long_nokey() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_key_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_key_short2() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_key_short_nokey() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_merge_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_merge_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_buffer_size_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_buffer_size_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_long_space() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_short_space() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_long_comma() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_short_comma() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_long_colon() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_short_colon() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_long_horizontal() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_short_horizontal() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_long_letter() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_short_letter() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_long_uppercase_letter() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_short_uppercase_letter() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_short_digital() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_field_separator_long_digital() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_temporary_directory_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_temporary_directory_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_stable_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_exist_file_stable_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let mut tmp_file = File::create(&file_path).unwrap();
            writeln!(
        ...
        #[test]
        fn test_ct_main_no_exist_file_reverse_short_sort_long_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_default_no_exist_file() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_ignore_leading_blanks_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_ignore_leading_blanks_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_dictionary_order_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_dictionary_order_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_ignore_case_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_ignore_case_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_general_numeric_sort_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_general_numeric_sort_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_ignore_nonprinting_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_ignore_nonprinting_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_month_sort_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_month_sort_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_human_numeric_sort_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_human_numeric_sort_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_numeric_sort_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_numeric_sort_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_random_sort_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_random_sort_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_reverse_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_reverse_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_random_sort_short_random_source() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
            let random_path = dir.path().join("random");
        ...
        #[test]
        fn test_ct_main_no_exist_file_sort_long_general_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_sort_long_human_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_sort_long_month() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_sort_long_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_sort_long_random() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_sort_long_version() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_reverse_short_sort_long_general_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_reverse_short_sort_long_human_numeric() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_reverse_short_sort_long_month() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_zero_terminated_long_output_file_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_zero_terminated_short_output_file_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_unique_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_unique_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_check_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_check_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_check_uppercase_c_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_check_long_diagnose_first() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_check_long_silent() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_check_long_quiet() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_check_short_quiet() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_check_short_diagnose_first() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_key_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_two_key_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_key_long_nokey() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_key_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_key_short2() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_key_short_nokey() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_merge_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
            let file_name = file_path.to_str().unwrap();
        ...
        #[test]
        fn test_ct_main_no_exist_file_field_separator_long_letter() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_field_separator_short_letter() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_field_separator_long_uppercase_letter() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_field_separator_short_uppercase_letter() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_field_separator_short_digital() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_field_separator_long_digital() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_temporary_directory_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_temporary_directory_short() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
        ...
        #[test]
        fn test_ct_main_no_exist_file_stable_long() {
            let dir = tempdir().unwrap();
            let file_path = dir.path().join("sort_test_file");
