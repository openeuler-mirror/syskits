...
which means ct_tail cannot detect this.
See also, e.g. the discussion at:
<https://github.com/ctutils/coreutils/issues/2873>
...
however in ct_tail these system calls are invoked from a separate thread.
