...
/// use `ct_println_verbatim`. This will preserve invalid unicode.
///
/// # Examples
/// ```
/// use std::path::Path;
...
/// Like `ct_println_verbatim`, without the trailing newline.
...
mod tests {
    ...
    /// 测试 `ct_println_verbatim` 函数能否在不同的输入下成功执行。
    #[test]
    ...
    /// 测试 `ct_println_verbatim` 能否正确处理空路径。
    #[test]
    ...
    /// 测试 `ct_println_verbatim` 能否处理非常长的路径。
    #[test]
    ...
    /// 测试 `ct_println_verbatim` 在处理包含特殊文件系统字符的路径时的行为。
    #[test]
    ...
    /// 测试 `ct_println_verbatim` 在处理仅包含特殊文件系统字符的路径时的行为。
    #[test]
    ...
    /// 测试 `ct_print_verbatim` 能否正确处理空路径。
    #[test]
    ...
    /// 测试 `ct_print_verbatim` 能否处理包含特殊字符的路径。
    #[test]
    ...
    /// 测试 `ct_print_verbatim` 能否处理非常长的路径。
    #[test]
